...
[🔥] 𝙎𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 : 𝙄𝙘𝙝𝙖𝙣 𝙂𝙖𝙢𝙞𝙣𝙜 [🔥]
...
Title : ${atdl.title}`, `Auto Downloader By 𝒁𝑿𝒄𝒐𝒅𝒆𝒓𝑰𝑫`, ftext)
}
}
...
const seactions = [{
title: `𝐋𝐢𝐬𝐭 𝐌𝐞𝐧𝐮 𝐁𝐨𝐭 𝐈𝐜𝐡𝐚𝐧𝐙𝐗 𝐂𝐨𝐝𝐞𝐫-𝐈𝐃`,
rows: [
{title: `⫹⫺ 𝑴𝒆𝒏𝒂𝒎𝒑𝒊𝒍𝒌𝒂𝒏 𝑺𝒆𝒎𝒖𝒂 𝑴𝒆𝒏𝒖`, rowId: `${prefix}allmenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑼𝒏𝒕𝒖𝒌 𝑶𝒘𝒏𝒆𝒓`, rowId: `${prefix}ownermenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑩𝒐𝒕 𝑳𝒂𝒊𝒏𝒏𝒚𝒂`, rowId: `${prefix}othermenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑼𝒏𝒕𝒖𝒌 𝑫𝒐𝒘𝒏𝒍𝒐𝒂𝒅 𝑳𝒊𝒏𝒌`, rowId: `${prefix}downloadmenu`},
{title: `⫹⫺ 𝑹𝒂𝒉𝒂𝒔𝒊𝒂 𝒀𝒕𝒕𝒂 :𝒗`, rowId: `${prefix}bugmenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑼𝒏𝒕𝒖𝒌 𝑮𝒓𝒐𝒖𝒑`, rowId: `${prefix}groupmenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑮𝒂𝒎𝒆 𝑯𝒂𝒗𝒆 𝑭𝒖𝒏`, rowId: `${prefix}funmenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑼𝒏𝒕𝒖𝒌 𝑺𝒕𝒂𝒍𝒌𝒊𝒏𝒈 𝒄𝒊𝒆 :𝒗`, rowId: `${prefix}stalkermenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑼𝒏𝒕𝒖𝒌 𝑬𝒅𝒊𝒕 𝑭𝒐𝒕𝒐`, rowId: `${prefix}randfotomenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑲𝒖𝒎𝒑𝒖𝒍𝒂𝒏 𝑽𝒊𝒅𝒆𝒐`, rowId: `${prefix}randvideomenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑼𝒏𝒕𝒖𝒌 𝑩𝒖𝒂𝒕 𝑳𝒐𝒈𝒐`, rowId: `${prefix}textpromenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑷𝒉𝒐𝒕𝒐 𝑩𝒚 𝑰𝒄𝒉𝒂𝒏𝒁𝑿`, rowId: `${prefix}photooxymenu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑭𝒐𝒕𝒐 𝟑𝟔𝟎`, rowId: `${prefix}ephoto360menu`},
{title: `⫹⫺ 𝑴𝒆𝒏𝒖 𝑪𝒆𝒓𝒊𝒕𝒂 𝑷𝒆𝒏𝒅𝒆𝒌`, rowId: `${prefix}cerpenmenu`},
]}]
const listMenuMessage = { 
text: `Silahkan Kak @${sender.split("@")[0]} Pencet Button List Message Nya Di Bawah Ya`,
mentions: [sender],
footer: fake,
buttonText: 'List Button ©𝐈𝐜𝐡𝐚𝐧𝐙𝐗 𝐂𝐨𝐝𝐞𝐫-𝐈𝐃',
sections: seactions,
listType: 1}
